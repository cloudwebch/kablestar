jQuery(function(l) {
		...
		(this.$target = t),
			...
			0 !== this.$images.length
				? (t.data('product_gallery', this),
				  ...
				  e &&
						((this.flexslider_enabled =
							!1 !== e.flexslider_enabled &&
							this.flexslider_enabled),
						(this.zoom_enabled =
							!1 !== e.zoom_enabled && this.zoom_enabled),
						(this.photoswipe_enabled =
							!1 !== e.photoswipe_enabled &&
							this.photoswipe_enabled)),
				  ...
				  (this.onResetSlidePosition = this.onResetSlidePosition.bind(
						this
				  )),
	...
	(e.prototype.initFlexslider = function(t) {
				...
				0 < t.length &&
					t.each(function(t, e) {
						var i,
							...
							s = l(e).find('img');
						s.length &&
							((i = s.attr('data-large_image')),
							(o = s.attr('data-large_image_width')),
							(a = s.attr('data-large_image_height')),
							(r = {
								alt: s.attr('alt'),
								src: i,
								w: o,
		...
		l('.woocommerce-product-gallery').each(function() {
			l(this).trigger('wc-product-gallery-before-init', [
				this,
				wc_single_product_params,
			]),
				l(this).wc_product_gallery(wc_single_product_params),
				l(this).trigger('wc-product-gallery-after-init', [
					this,
					wc_single_product_params,
				]);
		});
